...
if (isset($_POST['1ON']))
{
exec('python /home/pi/Dev/Python/automate.py 7 0');
}
if (isset($_POST['1OFF']))
{
exec('python /home/pi/Dev/Python/automate.py 7 1');
}
if (isset($_POST['2ON']))
{
exec('python /home/pi/Dev/Python/automate.py 11 0');
}
if (isset($_POST['2OFF']))
{
exec('python /home/pi/Dev/Python/automate.py 11 1');
}
if (isset($_POST['3ON']))
{
exec('python /home/pi/Dev/Python/automate.py 12 0');
}
if (isset($_POST['3OFF']))
{
exec('python /home/pi/Dev/Python/automate.py 12 1');
}
if (isset($_POST['4ON']))
{
exec('python /home/pi/Dev/Python/automate.py 13 0');
}
if (isset($_POST['4OFF']))
{
...
if (isset($_POST['5ON']))
{
exec('python /home/pi/Dev/Python/automate.py 15 0');
}
if (isset($_POST['5OFF']))
{
exec('python /home/pi/Dev/Python/automate.py 15 1');
}
if (isset($_POST['6ON']))
{
exec('python /home/pi/Dev/Python/automate.py 16 0');
}
if (isset($_POST['6OFF']))
{
exec('python /home/pi/Dev/Python/automate.py 16 1');
}
?>
