...
<!-- Exemplo de inserção de fragmento -->
<!-- Pela especificação do JSP os fragmentos devem vir sempre antes do jsp:body, mesmo que no seu template ele esteja sendo utilizado depois. -->
<!-- ATENÇÃO: Não deve haver conteúdo (nem mesmo um comentário) entre tags:pageTamplate e as tags jsp: attribute. meu Código estava com comentários entre essas tags -->
...
<jsp:body>
	...
	<section class="container middle">
		...
		<h2>
			<a href="${s:mvcUrl('PC#finalizar').build()}produtos">Veja todos os livros que publicamos!</a>
		</h2>
	</section>
